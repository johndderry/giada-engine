...
gdAbout::gdAbout()
#ifdef WITH_VST
: gWindow(345, 405, "About GiadaEngine") {
#else
: gWindow(345, 320, "About GiadaEngine") {
#endif
	...
	sprintf(
	  ...
	  "Version " VERSIONE " (" __DATE__ ")\n\n"
		"Giada is Developed by Monocasual\n"
		"GiadaEngine is derived software in accordance with the GPL\n"
		"Based on FLTK (%d.%d.%d), RtAudio (%s), RtMidi (%s),\n"
		"MidiFile(%s), libsamplerate and libsndfile\n\n"
		...
		kernelMidi::getMidiFileVersion().c_str()
	);
