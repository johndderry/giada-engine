...
void setBeginEndChannel(class gdEditor *win, SampleChannel *ch, int b, int e, bool recalc=false, bool check=true);
...
void setBoost(class gdEditor *win, SampleChannel *ch, float val, bool numeric);
