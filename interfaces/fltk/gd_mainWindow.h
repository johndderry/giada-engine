...
public:
	...
	class gKeyboard   *uniKeyboard;
	class gLauncher   *launcher;
...
public:
	...
	static void cb_setOutVol(float v, void *);
	static void cb_setInVol(float v, void *);
...
private:
	...
	static void cb_updatePlay(int, void *p);
	static void cb_updateRecInput(int, void *p);
	static void cb_updateRecAction(int, void *p);
	static void cb_updateMetronome(int, void *p);
...
private:
	...
	class gClick   *bpm;
	class gClick   *incrBpm;
	class gClick   *decrBpm;
	class gClick   *meter;
	...
	static void cb_setBeatMeter  (int, int, void *p);

	static void cb_bpm       (Fl_Widget *v, void *p);
	static void cb_incrBpm   (Fl_Widget *v, void *p);
	static void cb_decrBpm   (Fl_Widget *v, void *p);
	...
	inline void __cb_incrBpm();
	inline void __cb_decrBpm();
