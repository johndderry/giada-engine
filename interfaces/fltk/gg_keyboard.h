...
public:
	...
	gColumn(int x, int y, int w, int h, int index, int mbreak, class gKeyboard *parent);
	~gColumn();
...
private:
	...
	static void cb_setChannelWithActions (void *, void *p);
	static void *cb_addChannel (int, void *, void *p);
	static void cb_clear(void *);
	static void cb_alert(const char *, void *);
	static void cb_labelWave(void *, const char *, void *);
	static void cb_setChanVol(void *, float, void *);
	static void cb_setChanMute(void *, bool, void *);
	static void cb_setChanSolo(void *, bool, void *);
