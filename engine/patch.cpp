...
std::string Patch::getValue(const char *in) {
...
const char *Patch::getValueC(const char *in) {
...
int Patch::open(const char *file)
{
	...
	//version = atof(getValueC("versionf"));
...
int Patch::getLastMidiId() 
{
	return atoi(getValue("lastMidiId").c_str());
}
